export const hotSettings = {
  ...
  colWidths: [41, 280, 80, 120, 175, 80],
  mergeCells: [
...
export const editableCells: Array<{r: number, c: number, value?: any}> = [
  {r: 3, c: 2}, {r: 4, c: 2}, {r: 5, c: 2}, {r: 6, c: 2}, {r: 7, c: 2}, {r: 8, c: 2}, {r: 9, c: 2}, {r: 10, c: 2}, {r: 11, c: 2}, {r: 12, c: 2}, {r: 13, c: 2},
  {r: 3, c: 3}, {r: 4, c: 3}, {r: 5, c: 3}, {r: 6, c: 3}, {r: 7, c: 3}, {r: 8, c: 3}, {r: 9, c: 3}, {r: 10, c: 3}, {r: 11, c: 3}, {r: 12, c: 3}, {r: 13, c: 3},
  {r: 3, c: 4}, {r: 4, c: 4}, {r: 5, c: 4}, {r: 6, c: 4}, {r: 7, c: 4}, {r: 8, c: 4}, {r: 9, c: 4}, {r: 10, c: 4}, {r: 11, c: 4}, {r: 12, c: 4}, {r: 13, c: 4},
  {r: 3, c: 5}, {r: 4, c: 5}, {r: 5, c: 5}, {r: 6, c: 5}, {r: 7, c: 5}, {r: 8, c: 5}, {r: 9, c: 5}, {r: 10, c: 5}, {r: 11, c: 5}, {r: 12, c: 5}, {r: 13, c: 5},
];
